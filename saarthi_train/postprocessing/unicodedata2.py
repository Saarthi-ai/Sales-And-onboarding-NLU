# Script modified from https://gist.github.com/anonymous/2204527
# Can be used to detect the script of a word. See get_script() below.
# Used in add_lang_labels.py
...
def get_script(text: str, method:str) -> str:
    
    commonality_ordered_scripts = ['Common', 'Latin', 'Greek', 'Cyrillic', 'Armenian', 'Hebrew', 'Arabic',
        'Syriac', 'Thaana', 'Devanagari', 'Bengali', 'Gurmukhi', 'Gujarati', 'Oriya',
        'Tamil', 'Telugu', 'Kannada', 'Malayalam', 'Sinhala', 'Thai', 'Lao', 'Tibetan',
        'Myanmar', 'Georgian', 'Hangul', 'Ethiopic', 'Cherokee', 'Canadian_Aboriginal',
        'Ogham', 'Runic', 'Khmer', 'Mongolian', 'Hiragana', 'Katakana', 'Bopomofo',
    ...
    scripts = [script_cat(ch)[0] for ch in text]    
    if method=="most_frequent":
        script = max(set(scripts), key=scripts.count)
    elif method=="most_unique":
        script = max(scripts, key=commonality_ordered_scripts.index)
    else:
